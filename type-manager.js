module.exports = class TypeManager
{
	constructor(logger)
	{
		...
		this.data = {
			...
			3 : { type : 'rgb', format : { power : 'boolean', brightness : 'number', saturation : 'number', hue : 'number' }, min : { brightness : 0, saturation : 0, hue : 0 }, max : { brightness : 100, saturation : 100, hue : 360 } },
			...
			9 : { type : 'dimmer', format : { power : 'boolean', brightness : 'number' }, min : { brightness : 0 }, max : { brightness : 100 } }
		};
	}
